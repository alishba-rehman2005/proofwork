  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        {errors.fullName?.[0] && <p className="text-sm text-red-600">{errors.fullName[0]}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        {errors.email?.[0] && <p className="text-sm text-red-600">{errors.email[0]}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        {errors.password?.[0] && <p className="text-sm text-red-600">{errors.password[0]}</p>}
      </div>
